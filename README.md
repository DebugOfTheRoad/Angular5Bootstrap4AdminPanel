# Angular5 and Bootstrap 4 Admin Panel
...
`Angular5Bootstrap4AdminPanel` provides the following features:
...
```bash
$ git clone https://github.com/raghav-rosberg/Angular5Bootstrap4AdminPanel
$ cd Angular5Bootstrap4AdminPanel
